...
/**
 * This class is used to provide a user with a list of items and choose one.  This assumes we must
 * scroll.
 *
 */
public class PopupSelection extends DialogBase {
     ...
     */
    public PopupSelection(Context context) {
        this(context, null, 0);
    }
     ...
     */
    public PopupSelection(Context context, AttributeSet attrs) {
     ...
     */
    public PopupSelection(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     *
     * @return  The popup_selection layout.
     */
    @Override
